...
public static class GoalManager
{
    ...
    private static int collisionRadius = 24;
    ...
    public static void Initialize(Texture2D textureSheet, 
        Rectangle initialActiveRectangle, Rectangle initialDisabledRectangle, 
