...
public static class PathFinder
{
    ...
    private static List<PathNode> FindAdjacentNodes(PathNode currentNode, PathNode endNode)
    {
        ...
        {
            adjacentNodes.Add(new PathNode(currentNode, endNode, 
                new Vector2(X - 1, Y), CostStraight + currentNode.DirectCost));
        }
        else
        {
            upLeft = false;
        ...
        {
            adjacentNodes.Add(new PathNode(currentNode, endNode,
                new Vector2(X, Y - 1), CostStraight + currentNode.DirectCost));
        }
        else
        {
            upLeft = false;
        ...
        {
            adjacentNodes.Add(new PathNode(currentNode, endNode,
                new Vector2(X - 1, Y - 1), CostDiagonal + currentNode.DirectCost));
        }
    ...
    public static List<Vector2> FindPath(Vector2 startTile, Vector2 endTile)
    {
        ...
        PathNode endNode = new PathNode(null, null, endTile, 0f);
        PathNode startNode = new PathNode(null, endNode, startTile, 0f);
