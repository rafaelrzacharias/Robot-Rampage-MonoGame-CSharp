...
public class Sprite
{
    ...
    public Sprite(Vector2 worldLocation, Texture2D texture,
    ...
    public Rectangle WorldRectangle
    {
        get {
            return new Rectangle(
                (int)worldLocation.X, (int)worldLocation.Y, FrameWidth, FrameHeight);
        }
    }
    ...
    public virtual void Draw(SpriteBatch spriteBatch)
    {
        if (!Expired)
        {
            ...
            {
                spriteBatch.Draw(Texture, ScreenCenter, Source, tintColor, 
                    rotation, RelativeCenter, 1.0f, SpriteEffects.None, 0.0f);
            }
        }
    }
}